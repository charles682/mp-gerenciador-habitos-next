function NewHabit(){
    ...
    return(
        <main className="container relative flex flex-col gap-8 px-12 pt-16">
            <h1 className="text-4xl font-light text-center text-white font-display"></h1>
            ...
            <form action={newHabit} className="flex flex-col gap-4 mt-4">
                ...
                <button type="submit" className="bg-[#45EDAD] font-display text-neutral-900 font-regular text-2xl p-2 rounded-md my-8">
                Cadastrar
                </button>
